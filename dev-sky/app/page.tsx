...
const navigation = [
  { name: "Contact me by email", href: "mailto:hey@zhhe.dev" },
];
    ...
    <div className="flex flex-col items-center justify-center w-screen h-screen overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black">
      ...
      <div className="hidden sm:block my-16 text-center animate-fade-in">
        <h2 className="px-8 text-sm text-zinc-500 select-none">
          Hi, I am a developer, creator, and designer.
          <div className={"mt-1"}>
            Now I'm a student currently studying in{" "}
            <span className={"underline underline-offset-1"}>Beijing</span>, China.
          </div>
        </h2>
      </div>
      <div
      ...
      >
        ...
        Hi, my name is <span className={"font-bold"}>He</span>. I am a developer, creator, and designer.
          <div className={"mt-2"}>
